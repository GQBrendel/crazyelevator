...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        void Update()
        {
            posAddShake = _initialPos;
            rotAddShake = _initialRot;
       ...
       /* void OnGUI()
        {
            if (GUI.Button(new Rect(10, 70, 50, 30), "Shake"))
            {
                StandardShake();
            }
        }*/

        public void StandardShake()
        {
            ShakeOnce(_magnitude, _roughness, _fadeInTime, _fadeOutTime);
        }
